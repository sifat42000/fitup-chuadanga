                ...
                <AccordionItem value="4">
                    ...
                    <AccordionContent>
                        ...
                        <div className='flex justify-between items-center pt-2'>
                            <span>{priceFilter.minPrice.toLocaleString('en-US', { style: 'currency', currency: 'BDT' })}</span>
                            <span>{priceFilter.maxPrice.toLocaleString('en-US', { style: 'currency', currency: 'BDT' })}</span>
                        </div>
